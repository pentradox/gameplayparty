...
<main class="container d-flex justify-content-center align-items-center" style="height: 100vh">
  <form class="col-sm-4 p-3 border border-dark" style=" !important;" action="<?php echo URLROOT ?>/Dashboard/createhall" method="POST">
    <h3 class="text-center">Bioscoopzaal Toevoegen</h3>
